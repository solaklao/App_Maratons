...
![Main Screen (Light)](screenshots/MainLight.png) ![Main Screen (Dark)](screenshots/MainDark.png)

![Login Screen (Light)](screenshots/LoginLight.png) ![Login Screen (Dark)](screenshots/LoginDark.png)

![Registration Screen (Light)](screenshots/RegisterLight.png) ![Registration Screen (Dark)](screenshots/RegisterDark.png)

![Profile Screen (Light)](screenshots/ProfileLight.png) ![Profile Screen (Dark)](screenshots/ProfileDark.png)

![Delete Dialog (Light)](screenshots/DeleteLight.png) ![Delete Dialog (Dark)](screenshots/DeleteDark.png)

![Chat Screen (Light)](screenshots/ChatLight.png) ![Chat Screen (Dark)](screenshots/ChatDark.png)
